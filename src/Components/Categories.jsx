  ...
  return (
    <div className='bg-white 2xl:px-[150px] w-full max-w-s   mx-auto  flex items-center justify-center'>
        <div className="">
          ...
          <div className='flex md:flex-row flex-col grid xl:grid-cols-3 md:grid-cols-2 gap-6 '>
            <div className='relative w-full'>
                <div className='absolute right-0 bg-primary px-4 py-1 text-[13px] rounded-tr-[10px] rounded-bl-[10px] text-[#fff] font-bold'>New</div>
          <div className="flex flex-col justify-center items-center border-2 border-primary rounded-[10px] p-3 w-[330px] hover:shadow-md transition-all duration-300">
            ...
            <h1 className='text-[20px] font-bold text-secondary'>Getting Started</h1>
          ...
          <div className="flex flex-col justify-center items-center border rounded-[10px] w-[330px] p-3 hover:shadow-md transition-all duration-300">
            ...
            <h1 className='text-[20px] font-bold text-secondary'>Using Calendly</h1>
            <p className='text-[14px] text-center'>
              Availability, Event Type Settings, and Multi-user
              features.     
            </p>
          </div>
          <div className="flex flex-col justify-center items-center border rounded-[10px] w-[330px] p-3 hover:shadow-md transition-all duration-300">
              <img src={mobile} alt=""  className='w-[100px] h-[100px] mb-2'/>
            <h1 className='text-[20px] font-bold text-secondary'>Calendly For Mobile</h1>
            <p className='w-[300px] text-[14px] text-center'>
              Mobile Apps for iOS & Android.          
            </p>
          </div>
          <div className="flex flex-col justify-center items-center border rounded-[10px]  w-[330px] p-3 hover:shadow-md transition-all duration-300">
              <img src={integrations} alt=""  className='w-[100px] h-[100px] mb-2'/>
            <h1 className='text-[20px] font-bold text-secondary'>Integrations & Automations</h1>
            <p className='w-[300px] text-[14px] text-center'>
              Includes Calendar Connections, Calendly
              Integrations, Workflows, and Emded Options.        
            </p>
          </div>
          <div className="flex flex-col justify-center items-center border rounded-[10px] w-[330px] p-3 hover:shadow-md transition-all duration-300">
              <img src={account} alt=""  className='w-[100px] h-[100px] mb-2'/>
            <h1 className='text-[20px] font-bold text-secondary'>Account Settings</h1>
            <p className='w-[300px] text-[14px] text-center'>
          ...
          <div className="flex flex-col justify-center items-center border rounded-[10px] w-[330px] p-3 hover:shadow-md transition-all duration-300">
            ...
            <h1 className='text-[20px] font-bold text-secondary'>Video Tutorials</h1>
            <p className='w-[300px] text-[14px] text-center'>
