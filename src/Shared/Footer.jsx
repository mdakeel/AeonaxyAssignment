    ...
    <div className=' 2xl:px-[150px] w-full max-w-s  mx-auto '>
        <div className='mt-6 p-6  items-center justify-center'>
            ...
            <div className=' md:w-3/4 w-full flex md:flex-row flex-col grid md:grid-cols-3 grid-cols-2 gap-6 p-8 xl:px-20 md:px-10 px-4'>
                ...
                <div className='  space-y-3'>
                <div>
                    <h1 className='text-secondary text-[20px] font-extrabold'>Developers</h1>
                </div>
                <div className='text-[14px] font-medium text-secondary space-y-1'>
                    <h3>Developers</h3>
                </div>
            ...
            <div className='flex  justify-between md:p-4 p-2'>
                <p className='text-secondary text-[10px] '>Copyroght Calendly 2024</p>
                <div className='flex space-x-1 items-center'><span className='bg-green-600 w-2 h-2 rounded-full '></span><p className='text-secondary text-[10px] '>Calendly Status</p></div>
